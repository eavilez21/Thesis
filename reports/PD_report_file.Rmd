...
# This is an implementation of predictive and predictive-deviance oriented segmentation and is intended to be executed in RStudio
...
average_levels_pe <- sapply(levels_pe, function (x) mean(x*x))
